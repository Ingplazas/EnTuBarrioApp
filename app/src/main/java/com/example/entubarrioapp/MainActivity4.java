...
public class MainActivity4 extends AppCompatActivity {
    ...
    private EditText etNombresC, etDireccionC, etTelefonoC, etEmailC, etPasswordC;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etNombresC = findViewById(R.id.et_NombreCliente);
    ...
    public void registrarC(View view) {
        ...
        String nombresC = etNombresC.getText().toString();
        ...
        if (!nombresC.isEmpty() && !direccionC.isEmpty() && !telefonoC.isEmpty() && !emailC.isEmpty() && !passwordC.isEmpty()) {
            ContentValues registro = new ContentValues();

            registro.put("nombreC", nombresC);
